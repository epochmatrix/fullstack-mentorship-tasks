...
const student1: MentorshipStudent = {
    id: 101, 
...
const displayStudentInfo = (student: MentorshipStudent, showCourses: boolean = true): void => {
...
const enrollNewCourse = (student: MentorshipStudent, newCourse: Course): number => {
...
const advancedTS: Course = { id: "CS104", title: "Advanced Interfaces & Narrowing", creditHours: 3 };
